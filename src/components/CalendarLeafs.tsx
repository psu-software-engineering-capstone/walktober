...
// below is the major function for this file. It populates the calendar and adds elements. Starting with day1 of the month.
// this is done by using an index variable "day" then incrementing it after each access AFTER it is determined that the day of the week has been hit.
// aka the number increments once the day of the week corresponds to the first day of the month. if it starts on wednesday it will not increment till it has passed over sun, mon, tues = 3 times.
