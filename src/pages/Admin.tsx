import { IonButton, IonButtons, IonCheckbox, IonCol, IonContent, IonDatetime, IonDatetimeButton, IonGrid, IonHeader, IonIcon, IonInput, IonItem, IonLabel, IonList, IonListHeader, IonModal, IonPage, IonRadio, IonRadioGroup, IonRow, IonTextarea, IonTitle, IonToolbar} from '@ionic/react';
    ...
    <IonPage>
      ...
      <IonContent fullscreen>
        ...
        <IonGrid class="invis-grid">
          <IonRow></IonRow>
          <IonRow>
            <IonCol class="invis-grid-col"><IonButton onClick={() => setIsOpenUser(true)} class="admin-button" size='large' expand='block'>User Settings</IonButton></IonCol>
            <IonCol class="invis-grid-col"><IonButton onClick={() => setIsOpenTeam(true)} class="admin-button" size='large' expand='block'>Team Settings</IonButton></IonCol>
            <IonCol class="invis-grid-col"><IonButton onClick={() => setIsOpenAnnouncements(true)} class="admin-button" size='large' expand='block'>Announcements</IonButton></IonCol>
            <IonCol class="invis-grid-col"><IonButton onClick={() => setIsOpenReport(true)} class="admin-button" size='large' expand='block'>Generate Report</IonButton></IonCol>
          </IonRow>
        </IonGrid>
        ...
        <IonItem>Users</IonItem>
          <IonGrid fixed={true}>
            <IonRow class="header-row">
              <IonCol size="3" class="header-col">Name</IonCol>

              <IonCol size="3" class="header-col">Team</IonCol>

              <IonCol size="4" class="header-col">Email</IonCol>

              <IonCol size="3" class="header-col">Total Steps</IonCol>

              <IonCol size="3" class="header-col">Actions</IonCol>
            </IonRow>
            ...
            <IonRow>
              ...
              <IonCol size="3">
                <IonButton size="small"><IonIcon slot="start" icon={closeCircleSharp}></IonIcon>Remove</IonButton>
          ...
          <IonModal isOpen={isOpenUser} backdropDismiss={false}>
            <IonHeader>
              <IonToolbar>
                ...
                <IonButtons slot="end">
                  <IonButton onClick={() => setIsOpenUser(false)} color="light">Close</IonButton>
                </IonButtons>
              </IonToolbar>
            </IonHeader>
          ...
          <IonModal isOpen={isOpenTeam} backdropDismiss={false}>
            <IonHeader>
              <IonToolbar>
                ...
                <IonButtons slot="end">
                  <IonButton onClick={() => setIsOpenTeam(false)} color="light">Close</IonButton>
                </IonButtons>
              </IonToolbar>
            </IonHeader>
            <IonContent className="ion-padding">
          ...
          <IonModal isOpen={isOpenAnnouncements} backdropDismiss={false}>
            <IonHeader>
              <IonToolbar>
                ...
                <IonButtons slot="end">
                  <IonButton onClick={() => setIsOpenAnnouncements(false)} color="light">Close</IonButton>
                </IonButtons>
              </IonToolbar>
            </IonHeader>
            <IonContent className="ion-padding">
              <IonItem>
                <IonTextarea placeholder="Type announcement message here" autoGrow={true}></IonTextarea>
              </IonItem>
              <IonGrid>
                <IonRow>
                  <IonCol size="7" class="invis-grid-col"><IonButton>Post Announcement</IonButton></IonCol>
                  <IonCol size="9" class="invis-grid-col"><IonButton>Schedule Announcement</IonButton><IonDatetimeButton datetime="datetime"></IonDatetimeButton></IonCol>
                </IonRow>
              </IonGrid>
              <IonGrid>
                <IonRow class="header-row">
                ...
                <IonRow>
                  ...
                  <IonCol size="4"><IonButton size="small"><IonIcon slot="start" icon={closeCircleSharp}></IonIcon>Remove</IonButton></IonCol>
                </IonRow>
                <IonRow>
                ...
                <IonRow>
                  <IonCol size="4">February 2, 2023 9:15AM</IonCol>
                  <IonCol size="8">Challenge #3</IonCol>
                  <IonCol size=""><IonButton size="small"><IonIcon slot="start" icon={closeCircleSharp}></IonIcon>Remove</IonButton></IonCol>
                </IonRow>
          ...
          <IonModal isOpen={isOpenReport}>
            <IonHeader>
              <IonToolbar>
                ...
                <IonButtons slot="end">
                  <IonButton onClick={() => setIsOpenReport(false)} color="light">Close</IonButton>
                </IonButtons>
              </IonToolbar>
            </IonHeader>
            <IonItem>
            ...
            <IonContent className="ion-padding">
              ...
              <IonButton class="modal-button" size='large' expand='block'>Generate Reports</IonButton>
            </IonContent>
          </IonModal>
      </IonContent>
    </IonPage>
