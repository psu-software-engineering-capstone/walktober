...
import { IonCol, IonInput, IonItem, IonLabel } from '@ionic/react';
...
const Metric = (props: any): ReactElement => {
  const imperial = (
    <>
      <IonCol size="auto">
        <IonItem>
          <IonLabel id="miles" position="floating">
            Number of miles
          </IonLabel>
          <IonInput
            min="0.01"
      ...
      <IonCol size="auto">
        ...
        <IonItem>
          <IonLabel id="height-ft" position="floating">
            Optional: Height ft
          </IonLabel>
          <IonInput
            min="1"
      ...
      <IonCol size="auto">
        <IonItem>
          <IonLabel id="height-in" position="floating">
            Optional: Height In
          </IonLabel>
          <IonInput
            min="0.5"
  ...
  const metricVal = (
    <>
      ...
      <IonCol size="auto">
        <IonItem>
          <IonLabel id="height-cm" position="floating">
            Optional: Height cm
          </IonLabel>
          <IonInput
            min="0.1"
  ...
  return props.metric ? metricVal : imperial;
};
